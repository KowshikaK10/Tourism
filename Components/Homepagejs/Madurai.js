...
import {MaduraiContent} from './ContentDetails';
import { Container, Row, Col, Card ,Button} from "react-bootstrap";
import {maduraiCard} from "./CardDetails";
const Content = () => {
    return (
        <div id='madurai'>
        <div className='content pt-5'>
            {MaduraiContent.map((content)=>(
                <>
        ...
        <div>
        <h3 style={{textAlign:'center'}}>Must Visit Place In Madurai</h3>
       <div className='pb-5'>
        <Container>
            <Row>
                {maduraiCard.map((placeCardDetail)=>(
