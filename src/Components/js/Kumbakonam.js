...
import {KumbakonamContent} from './ContentDetails';
import { Container, Row, Col, Card ,Button} from "react-bootstrap";
import {kumbakonamCard} from "./CardDetails";
const Content = () => {
    return (
        <div id='kumbakonam'>
        <div className='content pt-5'>
            {KumbakonamContent.map((content)=>(
                <>
        ...
        <div>
        <h3 style={{textAlign:'center'}}>Must Visit Place In Kumbakonam</h3>
       <div className='pb-5'>
        <Container>
            <Row>
                {kumbakonamCard.map((placeCardDetail)=>(
