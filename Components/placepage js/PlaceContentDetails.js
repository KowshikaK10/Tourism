import chennaiImg1 from '../images/Content/chennai/chennai_img1.jpeg';
import chennaiImg2 from '../images/Content/chennai/chennai_img2.jpeg';
import chennaiImg3 from '../images/Content/chennai/chennai_img3.jpeg';
import chennaiImg4 from '../images/Content/chennai/chennai_img4.jpeg';

// rameshwaram
import rameshwaramimg1 from '../images/Content/rameshwaram/rameshwaram_img1.jpeg';
import rameshwaramimg2 from '../images/Content/rameshwaram/rameshwaram_img2.jpeg';
import rameshwaramimg3 from '../images/Content/rameshwaram/Rameshwaram_img3.jpeg';
import rameshwaramimg4 from '../images/Content/rameshwaram/rameshwaram_img4.jpeg';

//kodaikanal
import kodaikanalimg1 from '../images/Content/kodaikanal/kodaikanal_img1.jpeg';
import kodaikanalimg2 from '../images/Content/kodaikanal/kodaikanal_img2.jpeg';
import kodaikanalimg3 from '../images/Content/kodaikanal/kodaikanal_img3.jpeg';
import kodaikanalimg4 from '../images/Content/kodaikanal/kodaikanal_img4.jpeg';
//ooty
import ootyimg1 from '../images/Content/ooty/ooty_img1.jpeg';
import ootyimg2 from '../images/Content/ooty/ooty_img2.jpeg';
import ootyimg3 from '../images/Content/ooty/ooty_img3.jpeg';
import ootyimg4 from '../images/Content/ooty/ooty_img4.jpeg';
//kanyakumari
import kanyakumariimg1  from '../images/Content/kanyakumari/kanyakumari1_img1.jpeg';
import kanyakumariimg2  from '../images/Content/kanyakumari/kanyakumari1_img2.jpeg';
import kanyakumariimg3  from '../images/Content/kanyakumari/kanyakumari1_img3.jpeg';
import kanyakumariimg4  from '../images/Content/kanyakumari/kanyakumari1_img4.jpeg';
//kumbakonam
import kumbakonamimg1 from '../images/Content/kumbakonam/kumbakonam_img1.jpeg';
import kumbakonamimg2 from '../images/Content/kumbakonam/kumbakonam_img2.jpeg';
import kumbakonamimg3 from '../images/Content/kumbakonam/kumbakonam_img5.jpg';
import kumbakonamimg4 from '../images/Content/kumbakonam/kumbakonam_img4.jpeg';
// //madurai
import maduraiimg1 from '../images/Content/madurai/madurai_img1.jpeg';
import maduraiimg2 from '../images/Content/madurai/madurai_img2.jpeg';
import maduraiimg3 from '../images/Content/madurai/madurai_img3.jpeg';
import maduraiimg4 from '../images/Content/madurai/madurai_img4.jpeg';
//yercaud
import yercaudimg1 from '../images/Content/yercaud/yercaud_img1.jpeg';
import yercaudimg2 from '../images/Content/yercaud/yercaud_img2.jpeg';
import yercaudimg3 from '../images/Content/yercaud/yercaud_img3.jpeg';
import yercaudimg4 from '../images/Content/yercaud/yercaud_img4.jpeg';
//theni
import theniimg1 from '../images/Content/theni/theni_img1.jpeg';
import theniimg2 from '../images/Content/theni/theni_img2.jpeg';
import theniimg3 from '../images/Content/theni/theni_img3.jpeg';
import theniimg4 from '../images/Content/theni/theni_img4.jpeg';
//hogenakkal
import hogenakkalimg1 from '../images/Content/hogenakkal/hogenakkal_img1.jpeg';
import hogenakkalimg2 from '../images/Content/hogenakkal/hogenakkal_img2.jpeg';
import hogenakkalimg3 from '../images/Content/hogenakkal/hogenakkal_img3.jpeg';
import hogenakkalimg4 from '../images/Content/hogenakkal/hogenakkal_img4.jpeg';


export const chennaiDetails=[{
    placeImg :chennaiImg1,
    placeHeading:`Marina beach,Overview`,
    placeDetails1 :`Situated in the city of Chennai in Tamil Nadu, Marina Beach is a natural urban beach along the Bay of Bengal. Thebeach is stretched out to a distance of 13 kilometres making it the longest natural urban beach in the country, secondlargest in the world and also the most crowded beach in India with almost 30,000 visitors a day.`,
    placeDetails2:`With a white sandy shore that looks as though extending to infinity, the landscape of Marina Beach is a mesmerising and serene sight to behold, The beach has a primarily sandy terrain and is dotted with plenty of mery-go-rounds and shops selling souvenirs. You could take a walk along the Marina beach with your near and dear ones or even allalone and enjoy the cool evening sea breeze along with a hot plate of crispy sundal and murukku. Watching the sun crawlupwards into the sky or even disappear into the ocean from the beach, is an awe-striking and enchanting experience.`
},{
    placeImg :chennaiImg2,
    placeHeading:`MGR Flim City, Overview`,
    placeDetails1 :`Having been established in the year 1994, a considerably new structure, the MGR Film city is managed by the Government of Tamil Nadu in loving memory of MG Ramachandran who was not only a crowd-pleasing tamil actor but
    also a longtime CM of Tamil Nadu.`,
    placeDetails2:`With a white sandy shore that looks as though extending to infinity, the landscape of Marina Beach is a mesmerising and serene sight to behold, The beach has a primarily sandy terrain and is dotted with plenty of mery-go-rounds and shops selling souvenirs. You could take a walk along the Marina beach with your near and dear ones or even allalone and enjoy the cool evening sea breeze along with a hot plate of crispy sundal and murukku. Watching the sun crawlupwards into the sky or even disappear into the ocean from the beach, is an awe-striking and enchanting experience.`
},{
    placeImg :chennaiImg3,
    placeHeading:`Marundeeswarar Temple, Overview`,
    placeDetails1 :`The magnificent Marundeeswarar Temple, in Tiruvanmiyur, near Chennai has the temple deity Shiva in the form
    ...
    placeDetails2:`Glorified in the 7th-8th century by Nayanars (Saivite Saints), Tirugnana Sambandar, and Appar, the temple was
    ...
    placeImg :chennaiImg4,
    placeHeading:`Breezy Beach, Overview`,
    placeDetails1 :`Breezy Beach lays in the remote and serene neighbourhood of Valmiki Nagar in Chennai, Being smaller and
    less polluted, its a perfect getaway for anyone looking for a peaceful evening.`,
    placeDetails2:`This beach is not as popular and known as the Elliots beach, and is hence more quiet and peaceful. Evenings
...
export const rameshwaramDetails =[{
    placeImg : rameshwaramimg1,
    placeHeading:`Dhanushkodi Temple, Overview`,
    placeDetails1 :` Dhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, due to a
    natural calamity, the cyclone, it got completely washed away.`,
    placeDetails2:` It holds the advantage of being on an island and is exquisitely covered by waters on all the four sides of it. It is
...
{
    placeImg :rameshwaramimg2,
    placeHeading:`Lakshmana Temple, Overview`,
    placeDetails1 :` Lakshmana Tirtham had been constructed in the loving memory of Lord Lakshman, brother of Lord Rama. In
    ...
    placeDetails2:`Several wonderful sculptures of Lord Lakshmana have been carved out from marble and the temple has the
    statues of lord Rama and Goddess Sita too which signifies the spirit of unitedness that exisited between them.`
},
{
    placeImg :rameshwaramimg4,
    placeHeading:`Villoondi Tirtham, Overview`,
    placeDetails1 :`Viloondi Tirtham is a beach which is also considered a sacred natural water body and a favourite amongst
    ...
    placeDetails2:` Villoondi Theertham is situated about 6 km from the Rameswaram main bus stand. Besides its arresting views
...
{
    placeImg :rameshwaramimg3,
    placeHeading:`Rameshwaram Temple, Overview`,
    placeDetails1 :`A perfect blend of mind-boggling architecture and spiritual significance, Rameshwaram Temple, also known as
    ...
    placeDetails2:`The lingam in the Rameshwaram Temple was installed by Lord Rama but, the construction was led by several
...
export const kodaikanalDetails=[{
    placeImg :kodaikanalimg1,
    placeHeading:`Green Valley View, Overview`,
    placeDetails1 :`Formerly known as Suicide point, the Green Valley View offers a breathtaking view of the plains, deep valleys and
    ...
    placeDetails2:`Located at a distance of 5.5 km from the Kodaikanal Lake, the Green Valley View not just offers a gorgeous view,
...
{
    placeImg :kodaikanalimg2,
    placeHeading:`Kodai Lake, Overview`,
    placeDetails1 :`Kodaikanal Lake is a manmade lake in the Kodaikanal city which is also known as Kodai Lake. Vera Levinge was
    ...
    placeDetails2:`The star-shaped lake is centrally located in Kodaikanal and is surrounded by the rich green Palani Hill' Range
...
{
    placeImg :kodaikanalimg3,
    placeHeading:`Bear Shola Falls, Overview`,
    placeDetails1 :`Located at a mere distance of 2 kilometres from the Kodaikanal Lake, the Bear Shola Falls is a popular picnic spot
    ...
    placeDetails2:`Wrapped with dense forests coupled with the chirping of birds, Bear Shola Falls is a little heaven. Also, the forest
...
{
    placeImg :kodaikanalimg4,
    placeHeading:`Pillar Rocks, Overview`,
    placeDetails1 :`Situated in the "Princess of Hill stations', Kodaikanal, the Pillar Rocks have become a lovely picnic spot.
    ...
    existed on these rocks represented David Gell's excellent tribute to love.The view of rocks is not something to be missed.
    They stand as an untouched miracle for the tourists visiting Kodaikanal. `,
    placeDetails2:`The piars are famous for providing bird's view of nearby surroundings. The chambers between these two
...
export const ootyDetails =[{
    placeImg : ootyimg1,
    placeHeading:`Nilgiri Mountain Railway, Overview`,
    placeDetails1 :`Nilgiri Mountain Railway, also known as Toy Train in Ooty, is one of the key attractions of the popular hill station
    ...
    placeDetails2:` The Toy Train covers a distance of total 46 km in a span of 5 hours and takes one through a truly spectacular
...
{
    placeImg :ootyimg2,
    placeHeading:`Ooty Botanical Gardens, Overview`,
    placeDetails1 :` Ooty Botanical Gardens lie on the lower slopes of the Doddabetta peak, the Government Botanical Garden is a
    ...
    placeDetails2:`Visitors are greeted with astounding colourful natural beauty from the moment they pass through the gates
...
{
    placeImg :ootyimg3,
    placeHeading:`Emerald Lake, Overview`,
    placeDetails1 :`Emerald Lake is situated in Emerald Village, around 20-22 kilometres from the main city of Ooty and is a part of
    ...
    placeDetails2:`It is one of the unexplored and virgin places of the South Indian hill station, not yet encroached by the masses of the place every year. Emerala Lake 
    tourists that visit the place every year, Emerald Lake is the ideal spot in Ooty for nature lovers. Tourists usually flock there for the picturesque scenic beauty of the lake, and the green Nilgiri slopes and tea plantations surrounding it. It is a paradise for
    nature photography enthusiasts as the delightful landscape offers a perfect subject and composition.`
},
{
    placeImg :ootyimg4,
    placeHeading:`Dolphin's Nose, Overview`,
    placeDetails1 :`Located about 12 km away from Coonoor is the Dolphin's Nose about 1,500 meters above sea level. The tip of
    ...
    placeDetails2:` It is set amidst the rolling hils of the Nilgiris Hills (or the Blue Mountains). The gigantic rock formation is
...
export const kanyakumariDetails=[{
    placeImg :kanyakumariimg1,
    placeHeading:`Kanyakumari Beach, Overview`,
    placeDetails1 :`Located in the southernmost part of India, Kanyakumari beach with its beautiful hue-changing beaches, the
    ...
    placeDetails2:`The beach is not conducive to swim or surf as the water as the sea is rough and the beach is rocky.To enjoy the
    best view, you can visit the Triveni Sangam point and climb up the famous lighthouse watchtower to entirely take in its
    beauty.`
},
{
    placeImg :kanyakumariimg2,
    placeHeading:`Vivekananda Memorial, Overview`,
    placeDetails1 :`The magnificent Vivekananda Rock Memorial is located on a small island off Kanyakumari. t has the
    ...
    regular ferries. `,
    placeDetails2:`This statue was built in the year 1970 on the island situated in Vavathurai, built on the site where Vivekananda
...
{
    placeImg :kanyakumariimg3,
    placeHeading:`Thiruvalluvar Status, Overview`,
    placeDetails1 :` Dedicated to the accomplished philosopher and poet Thiruvalluvar, this beautiful statue finds itself on a small
    ...
    placeDetails2:`This monument stands tall at a mighty height of 133 feet and is perched upon a 38-foot pedestal. The pedestal's
...
{
    placeImg :kanyakumariimg4,
    placeHeading:`Thirparappu Falls, Overview`,
    placeDetails1 :`  Located at a distance of about 55 kilometers from Kanyakumari, the cascading waters of the Thirparappu Falls
    ...
    placeDetails2:`These falls are a unique combination of streams that flow together to form a magnificent waterfall. The
...
export const kumbakonamDetails=[{
    placeImg :kumbakonamimg1,
    placeHeading:`Sarangapani Temple, Overview`,
    placeDetails1 :`Sarangapani Temple, an ancient temple dedicated to Lord Vishnu, is located in the town of Kumbakonam in the
...
{
    placeImg :kumbakonamimg2,
    placeHeading:`Nageswaran Temple, Overview`,
    placeDetails1 :`Constructed as a chariot, the Nageswaran temple is an important Shaivite temple. A piece of genius Chola
    ...
    placeDetails2:`There are many inscriptions associated with the temple indicating contributions from Cholas, Thanjavur
...
{
    placeImg :kumbakonamimg3,
    placeHeading:`Adi Kumbeshwara Temple, Overview`,
    placeDetails1 :`  Believed to have been constructed in the 7th century A.D by the Cholas, Adi Kumbeshwara Temple is one of the
    ...
    placeDetails2:`The temple complex covers an area of 30,181 sq ft (2,803.9 m2) and houses four gateway towers known as
...
{
    placeImg :kumbakonamimg4,
    placeHeading:`Airavatesvara Temple, Overview`,
    placeDetails1 :`Located in the town of Darasuram near Kumbakonam in Tamil Nadu, Airavatesvara Temple is a revered Hindu
...
export const maduraiDetails =[{
    placeImg : maduraiimg1,
    placeHeading:`Vaigai Dam, Overview`,
    placeDetails1 :`Vaigai Dam, a magnificent human-made structure, is constructed over River Vaigai near Andipatti, Theni District
    ...
    placeDetails2: ` On one side of the dam is a beautiful garden known as Litle Brindavan maintained by the management for the
...
{
    placeImg :maduraiimg2,
    placeHeading:`Meghamalai, Overview`,
    placeDetails1 :` Often known as the "High Wavy Mountains ", Meghamalai is a petit yet beautiful place located in the Western
    ...
    placeDetails2:`The Meghamalai region of the Western Ghats is a paradise unexplored even by the people of Tamil Nadu. The
...
{
    placeImg :maduraiimg3,
    placeHeading:`Samanar Hills, Overview`,
    placeDetails1 :`Located in Keelakuyilkudi village near Madurai, Samanar Hills or Samanar Malai is a beautiful hill rock complex
    ...
    placeDetails2:`There is no better place to escape the heat than this picturesque getaway
...
{
    placeImg :maduraiimg4,
    placeHeading:`Thirumalai Nayakar, Overview`,
    placeDetails1 :`Thirumalai Nayakar Palace was erected in 1636 AD in the city of Madurai, by King Thirumalai Nayak. The
...
export const yercaudDetails=[{
    placeImg :yercaudimg1,
    placeHeading:`Pagoda Point, Overview`,
    placeDetails1 :`Located in the eastern part of the Yercaud Hills, Pagoda point is a beautiful viewpoint where one is treated to a
    ...
    placeDetails2:`Between the Pagodas here lies a temple devoted to Lord Rama. One can indulge in the amazing natural beauty
...
{
    placeImg :yercaudimg2,
    placeHeading:`Botanical Garden, Overview`,
    placeDetails1 :`Any tourist who is interested in gods gift to this planet, the wondrous flora, and in knowing about various
    species of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.`,
    placeDetails2:` Yercaud is the place where the famous Kurinji flower blooms in plenty and the specialty of this flower is that it
...
{
    placeImg :yercaudimg3,
    placeHeading:`Emerland Lake, Overview`,
    placeDetails1 :`The most aluring aspect of ercaud is its big yet natural lake very popularly known as the Emerald Lake.
    Surrounded by some wonderful cloud-peaked hills and a well persevered garden on its banks, this lake is a feast for the
    eyes.`,
    placeDetails2:`There is a floating fountain in the lake and boating facilities are available at a reasonable rate. Self-driven as well
...
{
    placeImg :yercaudimg4,
    placeHeading:`Lady's Seat, Overview`,
    placeDetails1 :` Lady's Seat is a viewpoint that overlooks the winding ghat road and offers a spectacular view of Mettur Dam
    ...
    placeDetails2:`It is believed that an English lady used to spend her evenings at this place watching the beautiful view of this
...
export const theniDetails=[{
    placeImg :theniimg1,
    placeHeading:`Chinna Suruli Falls, Overview`,
    placeDetails1 :`Located in the lap of wild, green forests, Chinna Suruli Falls is a picturesque destination to visit from Theni. It
    cascades all the way down from Meghamalai to form a pool of cool, sparkling water at the foothills of the mountain.Located around 54 kilometres away from the main centre, near the Kombaithozhu village, Chinna Suruli Falls is a lovely and
    ...
    placeDetails2:`Chinna Suruli Falls is one of the beautiful waterfalls near Madurai and the top visiting places in Megamalai range.
...
{
    placeImg :theniimg2,
    placeHeading:`Kumbakkarai Falls, Overview`,
    placeDetails1 :` Located in Dindigul district near Theni in Tamil Nadu, Kumbakkarai Falls is a mesmerising waterfall that is
    ...
    placeDetails2:`Besides boasting boasting of immense scenic beauty and the melodious tinkering of the gushing waters, the place also
...
},
{
    placeImg :theniimg3,
    placeHeading:`Meghamalai, Overview`,
    placeDetails1 :`Tucked within the Western Ghats of Tamil Nadu, Meghamalai in Theni district is the kind of hidden paradise that
    ...
    placeDetails2:`The Highwavys Mountain, locally called the Meghamalai, is an undulating terrain of peaks belonging to the
...
{
    placeImg :theniimg4,
    placeHeading:`Suruli Falls, Overview`,
    placeDetails1 :`Suruli Falls is a beautiful waterfall in the Theni district of Tamil Nadu and one of the major tourist attractions of
    ...
    placeDetails2:` At a distance of 123 kms from Madurai, 22 Kms from Thekkady (via Gudalur & Karuna Muthevan Patt), 10 Kms
...
export const hogenakkalDetails =[{
    placeImg :hogenakkalimg1,
    placeHeading:`Theerthamalai Temple,Overview`,
    placeDetails1 :`Theerthamalai is a popular pilgrim centre close to Hogenakkal. One of its most popular destinations is the
    Theerthamalai temple. Lord Theerthagireeswar, a form of Lord Shiva is the worshipping deity.`,
    placeDetails2:` It is believed that Lord Ram worshipped Lord Shiva at this temple to absolve him of the sin of killing so many
...
{
    placeImg :hogenakkalimg2,
    placeHeading:`Hogenakkal Falls, Overview`,
    placeDetails1 :`Hogenakkal Falls is a scintillating waterfall that is located on river Kaveri in the Dharmapuri district of Tamil
    ...
    India".`,
    placeDetails2:`The Kaveri River forks into multiple streams and falls through multiple steps, making the sight a mesmerising
...
{
    placeImg :hogenakkalimg3,
    placeHeading:`Pennagaram village, Overview`,
    placeDetails1 :`The village is located about 20 km away from Hogenakkal and is famous for its weekly fair that it holds every
    month to attract tourists, The village is also know for its brightly colored giant teracotta statues, which are known as
    Aiyanars.`,
    placeDetails2:`According to census 2011 information the sub-district code of Pennagaram Block (CD) is 05889. Total area of
...
{
    placeImg :hogenakkalimg4,
    placeHeading:`Mettur Dam, Overview`,
    placeDetails1 :`Mettur Dam, situated 30 miles from Salem in a small Mettur Village, is one of the largest dams in India. Built
    ...
    placeDetails2:`Apart from being a tourist hotspot, the dam also provides irrigation facility for 2,71,000 acres of agricultural
